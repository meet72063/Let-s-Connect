...
function NavList() {
  ...
  return (
    <List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1">
      ...
      >
        <ListItem className="flex items-center gap-2 py-2 pr-4" onClick={()=>{navigate('/Dashboard')}}>
      ...
      <Typography
        ...
        className="font-normal"
      >
        <ListItem className="flex items-center gap-2 py-2 pr-4" onClick={()=>{navigate('profile')}}>
...
export default function Example() {
  ...
  return (
    <>
    {err?<Error text={'Logging Out Failed..!'} error ={err} setError={setErr}/>:''}
    <Navbar className="mx-auto px-4 py-2">
      <div className="flex items-center justify-between text-blue-gray-900">
        ...
        <div className="hidden gap-2 lg:flex">
          ...
          <Button variant="gradient" size="sm" onClick={logOutHandler}>
            Log Out
          </Button>
